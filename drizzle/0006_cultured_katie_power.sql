ALTER TABLE "facilities" RENAME COLUMN "property_id" TO "content_id";--> statement-breakpoint
ALTER TABLE "facilities" DROP CONSTRAINT "facilities_property_id_content_id_fk";
